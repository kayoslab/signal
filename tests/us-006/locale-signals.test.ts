...
/**
 * Inline implementation of the locale signals collector.
 *
 * The real module will live at src/signals/locale-signals.ts.
 * These tests define the expected contract so the implementation
...
/** Stubbed version of collectLocaleSignals matching the planned contract. */
function collectLocaleSignals(): LocaleSignals {
  let timezone: string;
  try {
