...
function makeUnavailableSnapshot(): SignalSnapshot {
  return {
    ...
    webglParams: {
      ...
      extensionCount: 'unavailable' as unknown as number,
      extensions: [],
    },
    fonts: { detectedFonts: [], fontCount: 0 },
    speech: { voiceCount: 'unavailable' as unknown as number, voiceList: [], speechSupported: false },
    mediaFeatures: {
...
function makeUnknownSnapshot(): SignalSnapshot {
  return {
    ...
    webglParams: {
      ...
      extensionCount: 'unknown' as unknown as number,
      extensions: [],
    },
    fonts: { detectedFonts: [], fontCount: 0 },
    speech: { voiceCount: 'unknown' as unknown as number, voiceList: [], speechSupported: false },
    mediaFeatures: {
